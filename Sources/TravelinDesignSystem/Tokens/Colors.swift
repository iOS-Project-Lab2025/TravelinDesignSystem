...
public extension DesignTokens {
    ...
    enum Colors {
        ...
        public static let gradientColor1: Color = Color("gradientBackground1", bundle: .module)

        public static let gradientColor2: Color = Color("gradientBackground2", bundle: .module)
